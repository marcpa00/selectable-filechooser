...
//
// check to see if we already have a SelectableFilechooserGriffonAddon
// def configText = '''root.'SelectableFilechooserGriffonAddon'.addon=true'''
// if(builderConfigFile.text.contains(configText)) {
//     println 'Removing SelectableFilechooserGriffonAddon from Builder.groovy'
